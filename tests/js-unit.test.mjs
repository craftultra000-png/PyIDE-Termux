...
import { parseWebGLScene } from '../static/js/webgl-viewer.js';
...
assert.deepEqual(parseWebGLScene('{"type":"torus","size":3}'), { type: 'torus', size: 3 });
assert.equal(parseWebGLScene('{invalid-json').type, 'box');
